export const stock = [
    {
        ...
        opciones: [
            {
                valor: 'Wengue y tela Tokio',
                text: 'Wengue y tela Tokio'
            },
            {
                valor: 'Negro y tela Vellu Perla',
                text: 'Negro y tela Vellu Perla'
            },
            {
    ...
    },        
    {
        ...
        descripcion: 'Medidas: Alto 0.665 cm x Ancho 0.48 cm x Profundidad 0.50 cm. Telas a eleccion y lustre a eleccion.',
        opciones: [
            {
                valor: 'Wengue y tela Tokio',
                text: 'Wengue y tela Tokio'
    ...
    },
    {
        ...
        descripcion:'Juego de luces, base 700mm, Lampara G9, cromado exterior.',
        opciones: [
            {
                valor: '1 luz cromado plata',
                text: '1 luz cromado plata'
            },
            {
                valor: '2 luces cromado beige',
                text: '2 luces cromado beige'
            },
            {
                valor: '3 luces cromado rojo',
                text: '3 luces cromado rojo'
            }
        ]
    },
    {
        ...
        descripcion:'Colgante metalico campana con terminacion en diferentes colores para lampra E27 LED. Conjunto 5 colgantes.',
        opciones: [
            {
                valor: '1 luz cromado plata',
                text: '1 luz cromado plata'
            ...
            {
                valor: '2 luces cromado negro',
                text: '2 luces cromado negro'
            },
            {
                valor: '3 luces cromado azul',
                text: '3 luces cromado azul'
            }
        ]
        },
    {
        ...
        descripcion:'Colgantes realizados en vidrio esmerilado colores a eleccion para lampra E27 LED.',
        opciones: [
            {
                valor: '1 luz cromado plata',
                text: '1 luz cromado plata'
    ...
    },
    {
        ...
        descripcion:'Lampara realizada en ceramica y pantalla de cañamo.',
        opciones: [
            {
                valor: 'cañamo natural',
                text: 'cañamo natural'
            },
            {
                valor: 'cañamo beige',
    ...
    },
    {
        ...
        descripcion:'Lampara realizada en ceramica modelada y pantalla de cañamo.',
        opciones: [
            {
                valor: 'cañamo natural',
                text: 'cañamo natural'
    ...
    },
    {
        ...
        descripcion:'Lampara de pie movil pantalla de vidrio para luz G9.',
        opciones: [
            {
                valor: 'Pie madera',
                text: 'Pie madera'
    ...
    },
    {
        ...
        descripcion:'Pintura al oleo. Medidas varias.',
        opciones: [
            {
                valor: 'Medida 50cmx50cm',
                text: 'Medida 50cmx50cm'
            },
            {
                valor: 'Medida 100cmx100cm',
                text: 'Medida 100cmx100cm'
            },
            {
                valor: 'Medida 80cmx80cm',
                text: 'Medida 80cmx80cm'
            }
        ]
    },
    {
        ...
        descripcion:'Pintura realizada en acuarela. Medidas varias.',
        opciones: [
            {
                valor: 'Medida 50cmx50cm',
                text: 'Medida 50cmx50cm'
    ...
    },
    {
        ...
        stock: 10,
        informacion: 'Especie: Sansiviera',
        descripcion:'Requiere poco riego y luz necesaria y se adapata a cualquier lugar de la casa aportanto elegancia y sencillez.',
        opciones: [
            {
                valor: 'Especie Sansiviera',
                text: 'Especie Sansiviera'
            },
            {
                valor: 'Especie Potus',
                text: 'Especie Potus'
    ...
    },
    {
        ...
        categoria: 'Arteyvarios',
        precio: 1200,
        img: "/img/planta decoracion 2.jpg",
        stock: 10,
        informacion: 'Especie: Suculentas',
        descripcion:'Requiere poco riego y luz necesaria y se adapata a cualquier lugar de la casa aportanto elegancia y sencillez.',
        opciones: [
            {
                valor: 'Especie arbol de jade',
                text: 'Especie arbol de jade'
            },
            {
                valor: 'Especie sedum morganianum',
                text: 'Especie sedum morganianum'
            },
            {
                valor: 'Especie Echeverria elegans',
                text: 'Especie Echeverria elegans'
            },
    ...
    },
    {
        ...
        categoria: 'Arteyvarios',
        precio: 2200,
        img: "/img/planta decoracion 3.jpg",
        stock: 10,
        informacion: 'Especie: Suculentas',
        descripcion:'Requiere poco riego y luz necesaria y se adapata a cualquier lugar de la casa aportanto elegancia y sencillez.',
        opciones: [
    ...
    },
    {
        ...
        categoria: 'Arteyvarios',
        precio: 1200,
        img: "/img/almohadones 2.jpg",
        stock: 50,
        informacion: 'Almohadones varios estilos, materiales y texturas.',
        descripcion:'Distintos modelos para decorar el hogar rellenos de guata y forrados en distintas texturas.',
        opciones: [
            {
                valor: 'tela ratan',
                text: 'tela ratan'
    ...
    },
    {
        ...
        categoria: 'Arteyvarios',
        precio: 15200,
        img: "/img/juego de te.jpg",
        stock: 10,
        informacion: 'Bazar y decoracion.',
        descripcion:'Juego de 4 piezas en ceramica estilo asiatico.',
        opciones: [
            {
                valor: 'ceramica 4 piezas',
                text: 'ceramica 4 piezas'
            },
            {
                valor: 'ceramica 6 piezas',
                text: 'ceramica 6 piezas'
            },
    ...
    },
    {
        ...
        categoria: 'Arteyvarios',
        precio: 7200,
        img: "/img/espejo pared 2.jpg",
        stock: 10,
        informacion: 'Espejo colgante interior.',
        descripcion:'Espejo antiempañable con cuerda de sujecion en cuero estilo decorativo cinturon que decora cualquier sala de estar.',
        opciones: [
            {
                valor: '50cm diametro',
                text: '50 cm diametro'
    ...
    },
    {
        ...
        categoria: 'Arteyvarios',
        precio: 5200,
        img: "/img/reloj moderno.jpg",
        stock: 10,
        informacion: 'Reloj analogico decorativo',
        descripcion:'Reloj analogico hecho en piedra de distintas combinaciones. Medidas varias.',
        opciones: [
            {
                valor: '20cm diametro',
                text: '20 cm diametro'
    ...
    },
    {
        ...
        categoria: 'Arteyvarios',
        precio: 3200,
        img: "/img/compoteras ceramica.jpg",
        stock: 10,
        informacion: 'Compoteras fina ceramica italiana.',
        descripcion:'Compoteras realizadas en ceramica italiana de 500cc de capacidad.',
        opciones: [
            {
                valor: '250cc capacidad',
                text: '250cc capacidad'
            },
            {
                valor: '500cc capacidad',
                text: '500cc capacidad'
            },
            {
